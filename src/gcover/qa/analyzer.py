...
class QAAnalyzer:
    ...
    def extract_relevant_issues(
        ...
        # ========================================================================
        # Write combined output (as before)
        # ========================================================================
        combined_output_path = output_path.parent / "RC_combined" / output_path.name
        combined_output_path.parent.mkdir(parents=True, exist_ok=True)
        self._write_spatial_output(combined_layers, combined_output_path, output_format)
