...
2026-04-25  Added `border_segments` (classified RC1-RC1/RC1-RC2/RC2-RC2/land lines) and `tolerance_zones_Xm` / `strict_zones_Xm` polygon layers for QA error filtering near mapsheet borders
