...
# --- Variables ---
DELIVERY_DIR := /home/marco/DATA/Derivations/delivery/R16/
OUTPUT_DIR   := /home/marco/DATA/Derivations/output/test/
STYLES_DIR   := /home/marco/DATA/Derivations/output/R16/2026-01-12/
...
## smoke: Run smoke tests only (fastest) no ocverage
smoke:
...
all: $(DENORMALIZED_PATH) $(CLASSIFIED_PATH)

# 1. Merge sources and run diagnosis
$(MASTER_GDB): $(DELIVERY_DIR)RC1.gdb/timestamps $(DELIVERY_DIR)RC2.gdb/timestamps
